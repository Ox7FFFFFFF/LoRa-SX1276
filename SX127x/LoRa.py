...
class LoRa(object):
    ...
    @setter(REG.LORA.INVERT_IQ)
    def set_invert_iq_recv(self, invert):
        """ Invert the LoRa I and Q signals
        :param invert: 0: normal mode, 1: I and Q inverted
        :return: New value of register
        """
        return 0x26 | (invert & 0x01) << 6
    ...
    def set_parking_number(self,num):
        self.parking_number = num
