...
class LoRaArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self, description):
        ...
        self.add_argument('--freq', '-f', dest='freq', default=923.2, action="store", type=float,
                          help="Frequency")
        ...
        self.add_argument('--parking', '-pa', dest='parking', default=0, action="store", type=int,
                          help="Parking number. Default is 0")
    ...
    def parse_args(self, lora):
        ...
        lora.set_parking_number(args.parking)
        return args
